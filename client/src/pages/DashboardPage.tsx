...
import { getDashboardStatsRequest } from '../api/report';
    ...
    <div className="animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-indigo-600 rounded-xl shadow-lg p-6 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <button className="mt-6 w-full bg-white text-indigo-700 py-2 rounded-lg font-bold text-sm hover:bg-gray-100 transition shadow-sm">
